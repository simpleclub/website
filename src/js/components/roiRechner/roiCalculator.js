...
function calculateROI() {
  ...
  document.querySelectorAll('[total-savings]').forEach(el => {
    el.innerText = formattedSavings;
  });

  var formatedSavingsPerAzubi = savingsPerAzubi.toLocaleString('de-DE') + " €";

  document.querySelectorAll('[saving-potential]').forEach(el => {
    el.innerText = formatedSavingsPerAzubi;
  });
...
$('.roi-hero_slider_value_form').submit(function() {
  return false;
});
